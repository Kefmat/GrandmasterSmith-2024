 ...
 * @kilde https://tailwindcomponents.com/component/about-us - mye er lånt her i fra!
 * @description Layout for about section på /about
 */

const AboutSection = () => {
  return (
    <div className="bg-white shadow-md relative   flex flex-wrap items-start   overflow-hidden z-2 ">
      <div className="bg-dark text-secondary w-full py-5 px-10">
        ...
        <h2 className="max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
          Novice players become{" "}
          <span className="my-1 inline-block border-b-8 border-g4  px-4 font-bold text-g4 ">
            Grandmasters!
          </span>
        </h2>
      </div>
      <div className="relative mx-auto h-full px-4  pb-10   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 p-5  ">
        <div className="flex flex-col items-center justify-between gap-5 lg:flex-row px-10 py-5  ">
          <div className=" flex flex-row justify-between relative ">
            <div className="lg:max-w-xl lg:pr-5 relative z-30 mr-10">
              <Text
                variant="body1"
                size="lg"
                color="primary"
                className="text-left "
              >
                With our chess practice technology and social network, you will
                become the next Grand master!
              </Text>
              <Text
                variant="body1"
                size="lg"
              ...
              >
                Our platform is designed to help you improve your chess skills
              ...
              <Text
                ...
                className="text-left mt-5"
              >
                This site was made as a school asignment in the class App-2000
                in the year 2023/2024 by a Group of students from the University
              ...
              <div className="mt-10 flex flex-col items-center md:flex-row">
                <Link
                  href="/"
                  className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-dark px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-primary focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                >
                  Play now!
                </Link>
                <Link
                  href="/"
                  aria-label=""
                  className="group inline-flex items-center font-semibold text-g1 bg-slate-300 p-4"
                >
                  Watch how it works
                  <svg
            ...
            <img
              src="images/chess/lightning.webp"
              width="400"
              className="opacity-50   object-fill fill-y text-y rounded-lg hidden lg:flex flex-grow "
